                    ...
                    <div class="card-body">
                        ...
                        <form action="api/update_course.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="instructor" name="instructor" value="<?= htmlspecialchars($instructor) ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tag_id" name="tag_id" required>
                                    ...
                                    <?php foreach ($unique_tags as $tag): ?>
                                        <option value="<?= $tag['id'] ?>" style="color: <?= $tag['color'] ?>" <?= ($tag['id'] == $tag_id) ? 'selected' : '' ?>>
                            ...
                            <div id="new-tag-section" class="form-group d-none">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="color" class="form-control" id="color" name="color" style="max-width: 60px;">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="card-list">
                ...
                <div class="card fixed-height-card grow">
                    <div class="card-body">
                        ...
                        <p class="card-text"><span class="badge" style="background-color: <?= $tag_color ?>; color: <?= getContrastYIQ($tag_color) ?>"><?= htmlspecialchars($tag_name) ?></span></p>
                    </div>
                </div>
