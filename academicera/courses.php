...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 style="margin-left: 25px;">Hoş Geldin, <?= htmlspecialchars($first_name . ' ' . $last_name) ?></h3>
            </div>
        </div>
                ...
                <div class="card-list">
                    ...
                    if (!$courses_exist) {
                        echo "<div class='center-message card-list'>
                                ...
                                <a href='dashboard.php' class='btn btn-primary' style='align-items: center;'>Kurs Ekle</a>
                                <img src='empty.png' alt='empty' height='500px;'>
                              </div>";
                    }
